...
class CampusSubject extends Model
{
    ...
    protected $table = 'campus_subject';
    ...
    protected $tableColumnList = [
        ...
        'online_class_duration' => 'online_class_duration', 
    ...
    public function getOrderColumn($field)
    {
        ...
        foreach ($columnList as $key => $value) {
            if ($key === $field)
                return 'campus_subject.'.$key;
        }

        return 'campus_subject.'."id";
    }
...
//                'city_id' => 'required|integer',
                ...
                'subject_id' => [
                    'required', Rule::unique(Constant::Tables['campus_subject'], 'subject_id')->where(function ($query) use ($request) {
                ...
                'online_class_duration' => 'required|integer',            
                'subject_marks' => 'required|integer',            
...
//                'campus_id' => 'required|integer',
    ...
    public function messages($request, $method = null)
    {
        ...
        $commonMessages = [
            ...
            'subject_id.unique' => [
                "code" => 10102,
                "message" => "Please provide unique Subject."
            ],

//            'campus_name.min' => [
//                "string" => [
//                    "code" => 10104,
//                    "message" => "The CampusSubject name must be at least :min characters."
//                ]
//            ],
//            'campus_name.max' => [
//                "string" => [
//                    "code" => 10105,
//                    "message" => "The CampusSubject name may not be greater than :max characters."
//                ]
//            ],
            'campus_id.required' => [
                "code" => 10101,
