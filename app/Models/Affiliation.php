...
class Affiliation extends Model
{
    ...
    protected $table = 'affiliation_list';
...
//    }
    ...
    public function rules($request, $method = null)
    {
        ...
        $rules = match ($method) {
            'POST' => [
                ...
                'org_logo' => ['required','image', 'max:1000'],
                'org_address' => ['required','min:3', 'max:100'],
                'countries_id' => 'required',
                'org_contact' => ['required','integer', 'min:11', 'max:11'],
    ...
    public function messages($request, $method = null)
    {
        ...
        $commonMessages = [
            'org_prefix.required' => [
                "code" => 10101,
                "message" => "Please provide Affiliation Prefix."
            ],
            'org_prefix.unique' => [
                "code" => 10102,
                "message" => "Please provide unique Affiliation Prefix."
            ],
            'org_name.required' => [
                "code" => 10101,
                "message" => "Please provide Affiliation name."
            ],
            'org_name.unique' => [
                "code" => 10102,
                "message" => "Please provide unique Affiliation name."
            ],
            'name.alpha_space' => [
                "code" => 10103,
                "message" => "The Affiliation name may only contain letters and spaces."
            ],
            'name.min' => [
                "string" => [
                    "code" => 10104,
                    "message" => "The Affiliation name must be at least :min characters."
                ]
            ],
            'name.max' => [
                "string" => [
                    "code" => 10105,
                    "message" => "The Affiliation name may not be greater than :max characters."
                ]
            ],
            'name.alpha_space' => [
                "code" => 10103,
