...
class Classes extends Model
{
    ...
    public function rules($request, $method = null)
    {
        ...
        $rules = match ($method) {
            'POST' => [
                'class_name' => [
                    'required', Rule::unique('class', 'class_name')->where(function ($query) use ($request) {
    ...
    public function messages($request, $method = null)
    {
        ...
        $commonMessages = [
            ...
            'class_name.unique' => [
                "code" => 10102,
                "message" => "Please provide unique Class name."
            ],
            'class_desc.required' => [
                "code" => 10101,
                "message" => "Please provide Class Desc name."
            ],
            'name.alpha_space' => [
                "code" => 10103,
                "message" => "The Class name may only contain letters and spaces."
            ],
            'name.min' => [
                "string" => [
                    "code" => 10104,
                    "message" => "The Class name must be at least :min characters."
                ]
            ],
            'name.max' => [
                "string" => [
                    "code" => 10105,
                    "message" => "The Class name may not be greater than :max characters."
                ]
            ],
            'name.alpha_space' => [
                "code" => 10103,
