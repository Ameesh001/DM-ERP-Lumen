...
//    }
    ...
    public function rules($request, $method = null)
    {
        ...
        $rules = match ($method) {
            'POST' => [
                'user_type' => [
                    'required', Rule::unique($this->table, 'user_type')->where(function ($query) use ($request) {
    ...
    public function messages($request, $method = null)
    {
        ...
        $commonMessages = [
            'user_type.required' => [
                "code" => 10101,
                "message" => "Please provide UserType Prefix."
            ],
            'user_type.unique' => [
                "code" => 10102,
                "message" => "Please provide unique UserType Prefix."
            ]
        ];
