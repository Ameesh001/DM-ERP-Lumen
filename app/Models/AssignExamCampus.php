...
class AssignExamCampus extends Model
{
    // use HasFactory;

    protected $table = 'assign_exam_campus';
    ...
    protected $tableColumnList = [
        ...
        'assign_exam_hierarchy_id'  => 'assign_exam_hierarchy_id',
    ...
    public function rules($request, $method = null)
    {
        ...
        $rules = match ($method) {
            'POST' => [
                ...
                'assign_exam_hierarchy_id' => 'required|integer',
    ...
    public function messages($request, $method = null)
    {
        ...
        $commonMessages = [
            'examination_id.required' => [
                "code" => 10101,
                "message" => "Please examination_id ."
            ],
            'campus_id.required' => [
                "code" => 10101,
                "message" => "Please campus_id ."
            ],
            'assign_exam_hierarchy_id.required' => [
                "code" => 10102,
                "message" => "Please provide assign_exam_hierarchy_id."
            ],
        ];
