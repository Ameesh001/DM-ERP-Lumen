...
class ClassAssign extends Model
{
    ...
    public function rules($request, $method = null)
    {
        ...
        $rules = match ($method) {
            'POST' => [
                ...
                'session_id' => 'required',
                'class_id' => [
                    'required', Rule::unique('campus_class', 'class_id')->where(function ($query) use ($request) {
    ...
    public function messages($request, $method = null)
    {
        ...
        $commonMessages = [
            ...
            'Class.unique' => [
                "code" => 10102,
                "message" => "Please provide unique Campus Class name."
            ],
