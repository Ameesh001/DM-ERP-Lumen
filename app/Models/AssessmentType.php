...
class AssessmentType extends Model
{
    ...
    {
        return $this->belongsTo(AssessmentCategory::class, 'assessment_category_id')->select('id','assessment_category_name');
    }
    ...
    public function rules($request, $method = null)
    {
        ...
        $rules = match ($method) {
            'POST' => [
                ...
                'assessment_type_name' => [
                    'required', Rule::unique('assessment_type', 'assessment_type_name')->where(function ($query) use ($request) {
